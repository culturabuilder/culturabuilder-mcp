...
setuptools.setup(
    name="CulturaBuilder",
    version=get_version(),
    author="CulturaBuilder Team",
    author_email="contact@culturabuilder.dev",
    description="CulturaBuilder MCP - Framework integrador de comandos para Claude Code",
    long_description=get_long_description(),
    long_description_content_type="text/markdown",
    url="https://github.com/culturabuilder/culturabuilder-mcp",
    ...
    project_urls={
        ...
        "Documentation": "https://github.com/culturabuilder/culturabuilder-mcp/wiki",
        "Community": "https://github.com/culturabuilder/culturabuilder-mcp/discussions",
        "Bug Tracker": "https://github.com/culturabuilder/culturabuilder-mcp/issues",
    },
    classifiers=[
