"""
Metrics operations for CulturaBuilder Framework
...
def register_parser(subparsers, global_parser):
    ...
    parser = subparsers.add_parser(
        ...
        description="""
Manage and view CulturaBuilder usage metrics
...
All data is stored locally and never transmitted.
        ...
        epilog="""
Examples:
  CulturaBuilder metrics --enable              # Enable metrics collection
  CulturaBuilder metrics --status              # View current metrics status
  CulturaBuilder metrics --summary              # Display summary statistics
  CulturaBuilder metrics --export html         # Export metrics as HTML report
  CulturaBuilder metrics --export csv --days 7 # Export last 7 days as CSV
  CulturaBuilder metrics --clear                # Clear all metrics data
        """
    )
