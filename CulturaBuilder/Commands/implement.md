...
# /cb:implement - Feature Implementation
...
## Usage
```
/cb:implement [feature-description] [--type component|api|service|feature] [--framework react|vue|express|etc] [--safe]
```
...
## Examples
```
/cb:implement user authentication system --type feature --with-tests
